...
<html><head>
    <style>#ink-engine ink-body { background-color: red;}</style>
    </head><body>
    <h1>Test</h1>
    </body></html>
`;
...
exports[
  `tests/dompurify.test.js TAP dompurify - invalid xhtml > dompurify invalid xhtml 1`
] = `
...
exports[`tests/dompurify.test.js TAP dompurify - svg > dompurify svg 1`] = `
<svg xmlns="http://www.w3.org/2000/svg" height="20" width="38" style="background-color: red;"><path fill="#000" fill-rule="nonzero" d="M0 10c0 .546.414.983.932.983h33.887l-6.954 7.337a1.015 1.015 0 0 0 0 1.39.892.892 0 0 0 1.317 0l8.545-9.015a1.023 1.023 0 0 0 0-1.39L29.182.29a.892.892 0 0 0-1.317 0 1.015 1.015 0 0 0 0 1.39l6.954 7.337H.932C.414 9.017 0 9.454 0 10z"/></svg>
`;

exports[`tests/dompurify.test.js TAP dompurify - xhtml > dompurify xhtml 1`] = `
